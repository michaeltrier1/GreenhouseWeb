...
namespace GreenhouseWeb.Controllers
{
    public class GreenhousesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Greenhouse_ID,Password,ip,portnumber")] Greenhouse greenhouse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Greenhouse_ID,Password,ip,portnumber")] Greenhouse greenhouse)
        {
            if (ModelState.IsValid)
            {
